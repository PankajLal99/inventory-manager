...
export function normalizeLedgerExportSplit(
  ...
  const next: LedgerExportSplit = {
    useRows: !!useRows,
    useDays: !!useDays,
    rowsPerPage: clampInt(value?.rowsPerPage, 1, 200, DEFAULT_LEDGER_EXPORT_SPLIT.rowsPerPage),
    daysPerPage: clampInt(value?.daysPerPage, 1, 366, DEFAULT_LEDGER_EXPORT_SPLIT.daysPerPage),
  };
