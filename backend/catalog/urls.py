...
from .views import (
    ...
    defective_product_move_out_add_items, defective_selectable_barcodes
)
...
urlpatterns = [
    ...
    path('defective-products/selectable-barcodes/', defective_selectable_barcodes, name='defective-selectable-barcodes'),
