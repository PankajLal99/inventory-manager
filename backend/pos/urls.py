...
from .views import (
    ...
    repair_invoices_list, repair_status_choices, repair_device_models, find_repair_invoice_by_barcode, update_repair_status, generate_repair_label
)
...
urlpatterns = [
    ...
    path('pos/invoices/<int:pk>/edit/', invoice_edit, name='invoice-edit'),
    path('pos/invoices/<int:pk>/update/', invoice_update, name='invoice-update'),
    ...
    path('pos/repair/status-choices/', repair_status_choices, name='repair-status-choices'),
