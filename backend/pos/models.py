...
class InvoiceItem(models.Model):
    ...
    # Replacement POS: linkage to originating sale lines (optional FKs — only set on replacement-return invoices)
    ...
    original_invoice_number = models.CharField(max_length=100, blank=True)
    original_customer_name = models.CharField(max_length=200, blank=True)
